...
public abstract class ExperimentModuleGUI extends PluggedGUI<ExperimentModule> {
	...
	/*
	 * CoolItem coolItem = new CoolItem(coolBar, SWT.NONE); Composite composite
	 * = new Composite(coolBar, SWT.NONE); coolItem.setControl(composite);
	 * composite.setLayout(new FillLayout(SWT.HORIZONTAL)); Button btnNewExp =
	 * new Button(composite, SWT.NONE); btnNewExp.setText("New Experiment");
