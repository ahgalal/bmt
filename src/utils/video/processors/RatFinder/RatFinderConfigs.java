...
public class RatFinderConfigs extends FilterConfigs {

	public int max_thresh;
	public Point ref_center_point;


	public RatFinderConfigs (int max_thresh, Point ref_center_point,CommonConfigs common_configs)
	{
	...
	public void mergeConfigs(FilterConfigs configs) {
		RatFinderConfigs tmp_ratfiner_configs = (RatFinderConfigs)configs;
