...
public class VideoRecorderGUI
{
	...
	public VideoRecorderGUI(final Shell shell,Composite parent)
	{
		...
		btn_start_record.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
			...
			{
				PManager.getDefault().getVideoProcessor().getFilterManager().enableFilter("Recorder", true);
			}
		});
		...
		btn_stop_record.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
			...
			public void widgetSelected(final org.eclipse.swt.events.SelectionEvent e)
			{
				PManager.getDefault().getVideoProcessor().getFilterManager().enableFilter("Recorder", false);
				final FileDialog fileDialog = new FileDialog(shell, SWT.SAVE);
				final String file_name = fileDialog.open();
				((VideoRecorder) PManager.getDefault().getVideoProcessor().getFilterManager().getFilterByName(
