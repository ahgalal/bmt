...
public class Zone {
	 ...
	 * @param zoneNumber number to assign to the zone
	 * @param zoneType type of the zone
	 */
	public Zone(int zoneNumber,ZoneType zoneType) {
	...
	public void setZone_number(int zoneNumber) {
		zone_number = zoneNumber;
	}
	public ZoneType getZone_type() {
		return zone_type;
	}
	public void setZone_type(ZoneType zoneTpye) {
		zone_type = zoneTpye;
	}
	...
	public enum ZoneType {
		 ...
		 * @param str string containing the zone type
		 * @return ZoneType enum specified in the string
		 */
		public static ZoneType string2ZoneType(String str)
		{
		 ...
		 * @param zt zone type to convert to string
		 * @return String containing the zone type 
		 */
		public static String zoneType2String(ZoneType zt)
		{
			if(zt==NORMAL_ZONE)
				return "Normal";
