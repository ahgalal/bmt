/**
 * @(#)FilterImageOutputStream.java 1.0 15.06.2008 Copyright (c) 2008 Werner
 *                                  Randelshofer Hausmatt 10, CH-6405 Immensee,
 *                                  Switzerland All rights reserved. The
 *                                  copyright of this software is owned by
 *                                  Werner Randelshofer. You may not use, copy
 *                                  or modify this software, except in
 *                                  accordance with the license agreement you
 *                                  entered into with Werner Randelshofer. For
 *                                  details see accompanying license terms.
 */
...
public class FilterImageOutputStream extends FilterOutputStream
{
	...
	public FilterImageOutputStream(final ImageOutputStream iOut)
	{
		super(null);
		this.imgOut = iOut;
	}
