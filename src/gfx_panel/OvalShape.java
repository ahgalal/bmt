/*
 * this class is related to shape of zone 
 * Circular Zone 
 */
package gfx_panel;
...
public class OvalShape extends Shape {
	...
	private double PI = 3.14159;  // mathmatics constant
	private int diameter_x;      // position in X-axis
	private int diameter_y;     // postion in Y-axis
	
	/*
	 * the definition of this class need 4 parameters 
	 * its position in x-axis 
	 * its position in y-axis
	 * and its color 
	 */
