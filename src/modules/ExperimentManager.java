...
public class ExperimentManager
{
	...
	{
		experiment_configs = new ExperimentModuleConfigs(
				"Experiment Module", exp);
	...
	public boolean saveRatInfo()
	{
		...
		if (!override_rat)
			this.exp.getGroupByName(getCurrGrpName()).addRat(
					rat_tmp);
	...
	{
		excel_engine.writeExpInfoToExcelFile(
				FilePath,
				exp);
	}
