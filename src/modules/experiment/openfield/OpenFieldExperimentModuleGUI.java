...
{
	public OpenFieldExperimentModuleGUI(OpenFieldExperimentModule owner)
	{
		super(owner);
	}
	...
	/* (non-Javadoc)
	 * @see PluggedGUI#initialize(org.eclipse.swt.widgets.Shell, org.eclipse.swt.widgets.ExpandBar, org.eclipse.swt.widgets.Menu, org.eclipse.swt.widgets.CoolBar, org.eclipse.swt.widgets.Group)
	 */
	@Override
	...
	public void btnSetbgAction()
	{
		...
		{
			PManager.getDefault().drw_zns.setBackground(((OpenFieldExperimentModule)owner).updateRGBBackground());
