...
public abstract class BaseUI {
	 ...
	 * order.
	 * @param str_array array of strings that contains data to load to the GUI controls
	 */
	public abstract void loadData(String[] str_array);
	
	/**
	 * Registers the controller with the GUI. the Controller is the one who
	 * instantiates the GUI, so it has to register itself with the GUI for the GUI
	 * to be able to communicate with the controller.
