...
public class InputBox {
	 ...
	 * @param parent parent shell of this box
	 * @param title box title
	 * @param message box message
	 * @param enable_cancel show cancel button
	 */
	public InputBox(Shell parent,String title,String message,boolean enable_cancel)
	{
		msg=message;
	...
	private void createSShell() {
		if(enable_cancel)
			...
			sShell = new Shell(SWT.APPLICATION_MODAL | SWT.DIALOG_TRIM | SWT.ON_TOP| SWT.TITLE);
