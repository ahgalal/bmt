 ...
 * @author Creative
 */
public class HeadMotionModuleConfigs extends ModuleConfigs {
	/**
	 ...
	 */
	public HeadMotionModuleConfigs(final String moduleName) {
		super(moduleName);
	}

	@Override
	protected void initializeModuleID() {
		moduleID = HeadMotionModule.moduleID;
	}
	...
	public ModuleConfigs newInstance(final String moduleName) {
		return new HeadMotionModuleConfigs(moduleName);
	}
